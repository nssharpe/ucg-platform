 ...
 *
 * `allEventRegs` (Phase 3, data-layer-scale / COMPLETENESS): the FULL
 * by-event registration set (`useEventRegistrations(eventId).rows`, gated
 * on `status === 'ready'` by the caller) — this is rank/award/qualification
