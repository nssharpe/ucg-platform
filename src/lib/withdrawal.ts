...
// owners' spec 2026-08-23; `withdraw-registration` edge function). No
// React/store/Supabase imports; unit-tested in tests/withdrawal.test.ts.
// Mirrored server-side in supabase/functions/_shared/withdrawal.ts — KEEP IN
// LOCKSTEP (only field casing differs: camelCase here, snake_case there).
