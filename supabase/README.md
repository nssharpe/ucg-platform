...
(`supabase db push`), **except `20260711135842_emv2_p4_capacity_schema.sql`
and `20260711175608_emv2_p4_hold_clamp.sql`
(written, not yet pushed — see their rows above)**. Migrations are append-only —
