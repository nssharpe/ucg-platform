...
| [uat-stress-test-plan](plans/2026-08-19-uat-stress-test-plan.md) | Full-feature stress-test plan for Nate + Julia (240 steps, 17 lanes, spec-derived assertions); companion feedback workbooks + published page generated from it live in [`uat/`](uat/) | ð active (testing round in progress) |
