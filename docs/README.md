...
| [feedback-tracker](plans/2026-06-28-feedback-tracker.md) | 6/27 Gemini-organized feedback batch, cohorted A + B1–B8 | 🟡 Cohort A + B1–B3 + B6 + B8 shipped; **B4, B5, B7 (1 item) open** (see [CLAUDE.md](../CLAUDE.md) Deferred/TODO) |
