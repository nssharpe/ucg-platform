...
| [uiux-review-fixes](plans/2026-07-04-uiux-review-fixes.md) | Task briefs (by model class) from the 2026-07-04 live UI/UX review — money-story reconciliation, contrast, status badges, polish batch | 🟡 **partial** — S1–S3 shipped; O1/S4 money-story reconciliation implemented on branch `money/s4-cart-price-agreement` (2026-07-25, unmerged pending review); rest not started ([whats-next](whats-next.md) §3) |
