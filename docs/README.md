...
| [uiux-review-fixes](plans/2026-07-04-uiux-review-fixes.md) | Task briefs (by model class) from the 2026-07-04 live UI/UX review — money-story reconciliation, contrast, status badges, polish batch | 🔴 **not started** ([whats-next](whats-next.md) §3) |
